	...
	<div>
		...
		<div class="mt-3 p-8 bg-gray-200 rounded shadow-inner mb-8 relative h-full">
			<div class="grid lg:grid-cols-12 gap-x-6 gap-y-8">
				<div class="group relative z-50 inline-block text-left col-span-4" v-for="map, key in filters.data">
					<div>
					...
					<div class="origin-top-right relative z-50 hidden group-hover:block rounded-md shadow-lg">
						<div class="rounded-t-md bg-white shadow-xs">
...
export default {
	...
	methods: {
		...
		toogle (key, value = true) {
			this.openedFilters = Object.assign({}, this.openedFilters, { [key] : value})
			let el = document.getElementById(key)
			console.log(_.includes(this.openedFilters, key))
			// if (_.includes(this.openedFilters, key)) {
