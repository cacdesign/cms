<template>
  <div>
    <div class="bg-gray-900">
      <div class="max-w-screen-xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div class="text-center">
          <p
            class="mt-1 text-4xl leading-10 font-extrabold text-white sm:text-5xl sm:leading-none sm:tracking-tight lg:text-6xl"
          >
    ...
    <div
      class="max-w-screen-xl mx-auto px-4 sm:px-6 py-16 lg:py-20 overflow-hidden space-y-24"
    >
      <bet-filters />
          ...
          <div class="space-y-24">
            ...
            <div class="space-y-24">
              <div>
                ...
                <div
                  class="mt-5 grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-5"
                >
                  <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                      <dl>
                        <dt
                          class="uppercase text-sm leading-5 font-medium text-gray-500 truncate"
                        >
                          Nb de paris
                        </dt>
                        <dd
                  ...
                  <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                      <dl>
                        ...
                        <dd
                          class="mt-1 text-3xl leading-9 font-semibold"
                          :class="
                            formatToNumber(bets.stats.roi) > 0
                              ? 'text-green-400'
                              : 'text-red-500'
                          "
                        >
                    ...
                    <div class="px-4 py-5 sm:p-6">
                      <dl>
                        ...
                        <dd
                          class="mt-1 text-3xl leading-9 font-semibold"
                          :class="
                            formatToNumber(bets.stats.progression) > 0
                              ? 'text-green-400'
                              : 'text-red-500'
                          "
                        >
